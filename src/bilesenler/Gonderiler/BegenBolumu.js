...
const BegenBolumu = (props) => {
  ...
  const [begeniliyorMu, setBegeniliyorMu] = useState(false);

  const begeniHandler = () => {
    if (begeniliyorMu === false) {
      setBegeniliyorMu(true);
      gonderiyiBegen();
    }
  };
  ...
  return (
    <div>
      <div className="like-section" key="likes-icons-container">
        <div className="like-section-wrapper" onClick={begeniHandler}>
          <FontAwesomeIcon icon={faHeart} color={begeniliyorMu ? "red" : ""} />
        </div>
